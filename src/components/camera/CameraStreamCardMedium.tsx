"use client";
import { IconBorderCornerSquare, IconEye, IconMaximize } from "@tabler/icons-react";
...
export default function CameraStreamCardMedium() {
    ...
    return (
        < div className={cn("w-full min-h-100 max-h-100 aspect-video bg-white dark:bg-gray-800 rounded-4xl shadow-lg",
