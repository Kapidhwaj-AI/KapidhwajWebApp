...
import { IconX, IconCheck, IconMapPin, IconTrash, IconPencil, IconPlus } from '@tabler/icons-react';
...
export function AddNewSiteDialogue({ isOpen, onClose }: AddNewSiteDialogueProps) {
        ...
        <div className="fixed inset-0 bg-black/20 dark:bg-white/20 flex items-center justify-center z-50">
            <div className="bg-[var(--surface-200)] rounded-[50px] w-[95%] lg:w-2xl max-w-[800px] max-h-[97vh] px-10 pt-5 pb-4 shadow-xl flex flex-col">
                ...
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-medium">Add New Site</h2>
                    <button
                        onClick={onClose}
                    ...
                    <div>
                        ...
                        <div className="w-full lg:h-[300px] xl:h-[400px] bg-[var(--surface-100)] p-5 rounded-[24px]">
                            <div className="space-y-3 h-full overflow-y-auto pr-2 scrollbar-hide">
                                {/* Example Site Items */}
                                {[1, 2, 3, 4, 5, 6].map((_, index) => <div className="flex items-center p-3 bg-[var(--surface-200)] hover:bg-[var(--surface-300)] rounded-[12px] transition-colors">
