...
const StartAttendance = ({ onClose, isEdit, sites, categories }: { onClose: () => void; isEdit: boolean; sites: Organization[]; categories: Category[] }) => {
  ...
  return (
    <Modal onClose={onClose} title={t('custom_services.attendance')}>
