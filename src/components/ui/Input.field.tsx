    ...
    <div className="space-y-1.5 w-full  sm:space-y-2">
      ...
      <div className="relative">
        ...
        <input id={isOtp ? `otp-${index}` : `${label?.toLowerCase()}`}
          ...
          className="w-full h-[35px] sm:h-[40px] md:h-[45px] p-2 px-4 bg-transparent appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none   rounded-full border-none focus:outline-none ring-2 ring-[#2B4C88] dark:text-white"
        />
