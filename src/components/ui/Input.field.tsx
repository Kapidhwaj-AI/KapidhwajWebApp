    ...
    <div className="space-y-1.5 w-full  sm:space-y-2">
      ...
      <div className="relative">
        ...
        <input id={isOtp ? `otp-${index}` : `${label?.toLowerCase()}`}
          ...
          className={`w-full h-[35px] sm:h-[40px] md:h-[45px] p-2 px-4 ${disabled ?'bg-gray-200' :'bg-transparent'} z-50 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none  rounded-full  focus:outline-none border-2 border-[#2B4C88] text-gray-600 dark:text-white`}
        />
