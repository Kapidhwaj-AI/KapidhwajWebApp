    ...
    return ReactDOM.createPortal
        (
            <div className="fixed inset-0  z-50 flex items-center justify-center bg-black/50 backdrop-blur-md">
                <div className={className ? className : "bg-[var(--surface-200)] dark:bg-gray-800 max-h-[90vh] overflow-auto scrollbar-hide rounded-[29px] w-[90%] md:w-[748px] h-auto  p-4 md:p-8 shadow-xl flex flex-col"}>
