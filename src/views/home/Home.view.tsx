...
const HomeView: React.FC<HomeViewProps> = ({handleNearbyHubsAccess, devices, isRemotely, isHubLoading, isSavedHubLoading, nearbyHubs, savedHubs, fetchHub, fetchSavedHubs, handleAccessRemotely }) => {
    return (
