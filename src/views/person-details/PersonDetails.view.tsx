            ...
            {isLoading ? <Spinner /> : <>
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 ">
                    <div className='flex items-center gap-3'>
                        <Image priority={false} className="rounded-full object-cover w-20 h-20 aspect-auto" src={BASE_URL + ':3000/' + personDetails[0]?.persons[0]?.gcp_image_path} alt={personDetails[0]?.persons[0]?.name} width={200} height={200} />
